        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Name:</strong>
                    <input type="text" name="name" value="{{ $main->name }}" class="form-control" placeholder="Name">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:50px" name="price"
                        placeholder="price">{{ $main->price }}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>describe:</strong>
                    <input type="text" name="describe" class="form-control" placeholder="{{ $main->describe }}"
                        value="{{ $main->describe }}">
                </div>
            </div>
